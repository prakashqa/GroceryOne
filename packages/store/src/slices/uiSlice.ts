...
export const uiSlice = createSlice({
  ...
  reducers: {
    ...
    clearAllToasts: (state) => { state.toasts = []; },
    ...
    setKeyboardVisible: (state, action: PayloadAction<boolean>) => { state.isKeyboardVisible = action.payload; },
  },
});

export const {
  setLoading, showToast, hideToast, clearAllToasts,
  openModal, closeModal, closeAllModals, setOnlineStatus, setKeyboardVisible,
} = uiSlice.actions;
...
export const selectIsKeyboardVisible = (state: { ui: UiState }) => state.ui.isKeyboardVisible;
