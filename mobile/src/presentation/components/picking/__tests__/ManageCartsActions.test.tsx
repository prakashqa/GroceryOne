/**
 * ManageCartsActions Tests
 * TDD tests for cart edit and delete functionality
 */
...
import ManageCartsScreen from '../../../screens/picking/ManageCartsScreen';
...
describe('ManageCartsScreen - Edit and Delete Actions', () => {
  ...
  describe('Edit (Rename) Cart', () => {
    it('should display edit button on cart list item', async () => {
      const { getByTestId } = renderWithProviders(<ManageCartsScreen />, {
    ...
    it('should open rename modal when edit button is pressed', async () => {
      const { getByTestId, getByText } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
      ...
      await waitFor(() => {
        expect(getByText('Rename Cart')).toBeTruthy();
      });
    });

    it('should pre-populate input with current cart name in rename modal', async () => {
      const { getByTestId } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
    ...
    it('should rename cart when save is pressed with valid name', async () => {
      ...
      // Modal should close
      await waitFor(() => {
        expect(queryByText('Rename Cart')).toBeNull();
      });
    ...
    it('should show error for duplicate cart name', async () => {
      const { getByTestId, getByText } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
  ...
  describe('Delete Cart', () => {
    it('should display delete button on cart list item', async () => {
      const { getByTestId } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
    ...
    it('should show confirmation alert when delete button is pressed', async () => {
      ...
      expect(Alert.alert).toHaveBeenCalledWith(
        'Delete Cart',
        'Are you sure you want to delete "Default Cart"?',
    ...
    it('should delete cart when confirmed', async () => {
      const { getByTestId, store } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
    ...
    it('should not delete cart when cancelled', async () => {
      const { getByTestId, store } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
    ...
    it('should reassign active cart when active cart is deleted', async () => {
      const { getByTestId, store } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
  ...
  describe('Cart Selection', () => {
    it('should change active cart when a different cart is pressed', async () => {
      const { getByTestId, store } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
    ...
    it('should update active cart indicator when cart is selected', async () => {
      const { getByTestId } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
    ...
    it('should navigate to Picking screen when a cart is pressed', async () => {
      const { getByTestId } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
  ...
  describe('Cart Creation Navigation', () => {
    it('should navigate to Picking screen after creating a new cart', async () => {
      const { getByTestId, getByText } = renderWithProviders(<ManageCartsScreen />, {
        preloadedState: defaultCartState,
      });
